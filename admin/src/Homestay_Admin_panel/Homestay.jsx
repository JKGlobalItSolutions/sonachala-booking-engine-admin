                ...
                <form onSubmit={handleSubmit}>
                  <div className="mb-3">
                    ...
                    <div className="card">
                      ...
                      <label htmlFor="hotelImages" className="btn mx-5 my-2  d-flex justify-content-center " style={{ backgroundColor: '#003B94', borderColor: '#003B94', color: 'white' }}>
                        Add Image
                      </label>
                      <input
                        type="file"
                  ...
                  <div className="text-center mt-4">
                    <button type="submit" className="btn px-5" style={{ backgroundColor: '#003B94', borderColor: '#003B94', color: 'white' }} disabled={isUploading}>
        ...
        <div className="delete-modal">
          <div className="delete-modal-content">
            ...
            <div className="d-flex justify-content-center gap-3">
              <button
                className="btn px-4"
                style={{ backgroundColor: '#003B94', borderColor: '#003B94', color: 'white' }}
